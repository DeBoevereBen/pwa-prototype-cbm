...
/***/ "../../../.nvm/versions/node/v11.10.0/lib/node_modules/webpack/buildin/amd-options.js":
/*!****************************************!*\
...
/***/ "../../../.nvm/versions/node/v11.10.0/lib/node_modules/webpack/buildin/global.js":
/*!***********************************!*\
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../../.nvm/versions/node/v11.10.0/lib/node_modules/webpack/buildin/global.js */ "../../../.nvm/versions/node/v11.10.0/lib/node_modules/webpack/buildin/global.js")))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../../.nvm/versions/node/v11.10.0/lib/node_modules/webpack/buildin/global.js */ "../../../.nvm/versions/node/v11.10.0/lib/node_modules/webpack/buildin/global.js"), __webpack_require__(/*! promise */ "./node_modules/promise/index.js")))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! promise */ "./node_modules/promise/index.js")))
...
var DOMModule = function () {
  ...
  var taskcardDetails = document.getElementById("taskcard_details");
  var reloadBtn = document.getElementById("reload");
  var favList = document.getElementById("favouriteList");
  var filteredCardsSelect = document.getElementById("filteredCards");
  ...
  DOMModule.prototype.updateCardSelect = function (cardsByTopic) {
    ...
    cardsByTopic[topic].forEach(function (card) {
  ...
  function getCardHtml(slug, taskcard) {
    var icon = !!taskcard.isFavourite ? "s" : "r";
    var content = "<h1>".concat(taskcard.title, " <i id='favBtn' data-slug=\"").concat(slug, "\" data-state=\"").concat(!!taskcard.isFavourite, "\"  class=\"fa").concat(icon, " fa-star\" style=\"color:yellow;\"></i></h1><br />");
    taskcard.content.forEach(function (contentBlock) {
      if (contentBlock.type == "image") {
        content = content + "<img src=\"".concat(contentBlock.value, "\">");
      } else {
  ...
  DOMModule.prototype.updateTopicSelect = function (cardsByTopic) {
    Object.keys(cardsByTopic).forEach(function (topic) {
      var topicOption = document.createElement("option");
  ...
  DOMModule.prototype.showFavouriteList = function (favourites, showCardDetailFromFavourites) {
    ...
    if (favourites.length === 0) {
      favList.innerHTML = "<option selected disabled>Add favourites</option>";
      return;
    }

    favourites.forEach(function (favourite) {
      var option = document.createElement("option"); // option.addEventListener("select", e => {
      //   showCardDetailFromFavourites(favourite.slug);
      // });

      option.innerHTML = "".concat(favourite.slug);
      option.value = "".concat(favourite.slug);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Promise, fetch) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataModule", function() { return DataModule; });
...
var DataModule = function () {
  ...
  var API_BASE = "https://cbmtje.herokuapp.com/apiv2/";
  var API_TASKCARD_ROOT = API_BASE + "en/taskcards/";
  var DBKey = "CBM";
  var FetchConf = {
    method: "GET",
    mode: "cors",
  ...
  var DataModule = function DataModule(version, domModule) {
    this.DOM = domModule;
  ...
  function upgradeDBCallback(upgradeDB) {
    var storenames = _toConsumableArray(upgradeDB.objectStoreNames);
    ...
    upgradeDB.createObjectStore("topics", {
      keyPath: "name"
    });
    upgradeDB.createObjectStore("cardDetails", {
      keyPath: "slug"
    });
    ...
    } catch (e) {// don't create, already exists
    }
  }

  DataModule.prototype.fetch =
  /*#__PURE__*/
  function () {
  ...
  DataModule.prototype.getTopicsWithCards =
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2() {
    var data, cardsByTopic;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return getCardsByTopicFromCache.call(this);
          ...
          case 7:
            ...
            _context2.next = 11;
            return this.fetch(API_TASKCARD_ROOT);

          case 11:
            data = _context2.sent;
            cardsByTopic = groupByTopic(data);
            this.saveTopicsWithCards(cardsByTopic);
            return _context2.abrupt("return", cardsByTopic);
    ...
    }, _callee2, this, [[0, 17], [1, 7]]);
  }));

  var getCardsByTopicFromCache =
  /*#__PURE__*/
  function () {
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return this.DB.then(function (db) {
                return db.transaction("topics").objectStore("topics").getAll();
    ...
    return function getCardsByTopicFromCache() {
      return _ref3.apply(this, arguments);
    };
  }();

  var groupByTopic = function groupByTopic(taskcards) {
    var cardsByTopic = {};
    taskcards.forEach(function (card) {
      card.field_tags.forEach(function (topic) {
  ...
  DataModule.prototype.saveTopicsWithCards =
  /*#__PURE__*/
  function () {
  ...
  var getCardDetailFromCache =
  /*#__PURE__*/
  function () {
    var _ref5 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee5(slug) {
      var cardDetail;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return this.DB.then(function (db) {
                console.log(db);
                return db.transaction("cardDetails").objectStore("cardDetails").get(slug);
              });

            case 2:
              cardDetail = _context5.sent;
              console.log("in dm get getCardDetailFromCache", cardDetail);
            ...
            case 6:
              return _context5.abrupt("return", cardDetail.details);
    ...
    return function getCardDetailFromCache(_x3) {
      return _ref5.apply(this, arguments);
    };
  }();

  function updateCacheAndNotifyUser(_x4) {
    return _updateCacheAndNotifyUser.apply(this, arguments);
  }
  /**
  ...
  */
  ...
  function _updateCacheAndNotifyUser() {
    _updateCacheAndNotifyUser = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee15(slug) {
      var cardDetailFromNetwork, cardDetailFromCache;
      return regeneratorRuntime.wrap(function _callee15$(_context15) {
        while (1) {
          switch (_context15.prev = _context15.next) {
            case 0:
              _context15.next = 2;
              return this.fetch("".concat(API_TASKCARD_ROOT).concat(slug));

            case 2:
              cardDetailFromNetwork = _context15.sent;
              _context15.next = 5;
              return getCardDetailFromCache.call(this, slug);

            case 5:
              cardDetailFromCache = _context15.sent;

              if (!(!cardDetailFromCache || cardDetailFromCache.changed !== cardDetailFromNetwork.changed)) {
                _context15.next = 12;
                break;
              }

              _context15.next = 9;
              return this.saveCardDetail(cardDetailFromNetwork, slug);
  ...
  DataModule.prototype.getCardDetail =
  /*#__PURE__*/
  function () {
    var _ref6 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee6(cardSlug, isRefresh) {
      var cardDetailFromCache, isFavourite;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.prev = 0;
              _context6.next = 3;
              return getCardDetailFromCache.call(this, cardSlug);

            case 3:
              cardDetailFromCache = _context6.sent;
              if (!isRefresh) updateCacheAndNotifyUser.call(this, cardSlug);

              if (cardDetailFromCache) {
                _context6.next = 7;
                break;
              }
            ...
            case 7:
              _context6.next = 9;
              return this.isFavourite(cardSlug);

            case 9:
              isFavourite = _context6.sent;
              console.log("in dm -=>", isFavourite);
            ...
            case 14:
              ...
              console.log("In the catch, serving from network");
              _context6.next = 19;
              return this.fetch("".concat(API_TASKCARD_ROOT).concat(cardSlug));
  ...
  DataModule.prototype.saveCardDetail =
  /*#__PURE__*/
  function () {
    var _ref7 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee7(details, slug) {
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              this.DB.then(function (db) {
                var tx = db.transaction("cardDetails", "readwrite");
  ...
  function _asyncForEach() {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee16(array, callback) {
      var index;
  ...
  function checkIfCardExists(_x11) {
    return _checkIfCardExists.apply(this, arguments);
  }

  function _checkIfCardExists() {
    _checkIfCardExists = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee17(slug) {
      return regeneratorRuntime.wrap(function _callee17$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              return _context17.abrupt("return", this.DB.then(function (db) {
                return db.transaction("cardDetails").objectStore("cardDetails").get(slug);
              }).then(function (card) {
  ...
  DataModule.prototype.checkForNewCardsAndSave =
  /*#__PURE__*/
  function () {
    var _ref8 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee9(sw) {
      var _this = this;

      var images, cards, cardsByTopic;
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 5:
              ...
              cardsByTopic = groupByTopic(cards);
              this.saveTopicsWithCards(cardsByTopic);
            ...
            case 11:
              ...
              console.log("No internet?", _context9.t0);
              return _context9.abrupt("return");

            case 15:
              _context9.next = 17;
              return asyncForEach(cards,
              /*#__PURE__*/
              function () {
                var _ref9 = _asyncToGenerator(
                /*#__PURE__*/
                regeneratorRuntime.mark(function _callee8(card) {
                  var newOrUpdated, detail;
                  return regeneratorRuntime.wrap(function _callee8$(_context8) {
                    while (1) {
                      switch (_context8.prev = _context8.next) {
                        case 0:
                          _context8.next = 2;
                          return checkIfCardExists.call(_this, card);

                        case 2:
                          newOrUpdated = _context8.sent;
                          ...
                          _context8.next = 6;
                          return _this.fetch("".concat(API_TASKCARD_ROOT).concat(card));

                        case 6:
                          detail = _context8.sent;

                          if (sw) {
                            detail.content.forEach(function (contentObj) {
                              if (contentObj.type === 'image') {
                                fetch(contentObj.value);
                              }
                            });
                          }

                          _context8.next = 10;
                          return _this.saveCardDetail(detail, card);
  ...
  DataModule.prototype.markFavourite =
  /*#__PURE__*/
  function () {
    var _ref10 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee10(slug) {
  ...
  DataModule.prototype.isFavourite =
  /*#__PURE__*/
  function () {
    var _ref11 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee11(slug) {
      return regeneratorRuntime.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              console.log("Looking for favo");
              _context11.next = 3;
              return this.DB.then(function (db) {
                return db.transaction("favourites").objectStore("favourites").get(slug);
              }).then(function (result) {
                console.log("the result in the favourites store: ", result, "so -> ", !!result);
                return !!result;
              }).catch(function (err) {
                console.log("error!!!!!!");
              });
  ...
  DataModule.prototype.removeFavourite =
  /*#__PURE__*/
  function () {
    var _ref12 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee12(slug) {
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              _context12.next = 2;
              return this.DB.then(function (db) {
                return db.transaction("favourites", "readwrite").objectStore("favourites").delete(slug);
              });
  ...
  DataModule.prototype.getFavouriteList =
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            _context13.next = 2;
            return this.DB.then(function (db) {
              return db.transaction("favourites").objectStore("favourites").getAll();
            }).then(function (res) {
              return res;
            });
  ...
  DataModule.prototype.cardsWithText =
  /*#__PURE__*/
  function () {
    var _ref14 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee14(inputText) {
      var searchVal, listOfCards, db, allCardDetails;
      return regeneratorRuntime.wrap(function _callee14$(_context14) {
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              searchVal = inputText.toLowerCase().trim();
              listOfCards = {};
              _context14.next = 4;
              return this.DB;
            ...
            case 4:
              db = _context14.sent;
              _context14.next = 7;
              return db.transaction("cardDetails").objectStore("cardDetails").getAll();

            case 7:
              allCardDetails = _context14.sent;
              allCardDetails.forEach(function (card) {
                if (card.slug && card.slug.toLowerCase().indexOf(searchVal) > -1 || card.details.field_body_text && card.details.field_body_text.toLowerCase().indexOf(searchVal) > -1) {
                  listOfCards[[card.slug]] = card.details.title; // listOfCards.push({[[card.slug]]: card.details.title});
                }
              });
              return _context14.abrupt("return", listOfCards);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! promise */ "./node_modules/promise/index.js"), __webpack_require__(/*! imports-loader?this=>global!exports-loader?global.fetch!whatwg-fetch */ "./node_modules/imports-loader/index.js?this=>global!./node_modules/exports-loader/index.js?global.fetch!./node_modules/whatwg-fetch/fetch.js")))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Promise) {/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es7.symbol.async-iterator */ "./node_modules/core-js/modules/es7.symbol.async-iterator.js");
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && __webpack_require__(/*! !webpack amd options */ "../../../.nvm/versions/node/v11.10.0/lib/node_modules/webpack/buildin/amd-options.js") ? define(['exports'], factory) : (global = global || self, factory(global.idb = {}));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Promise) {/* harmony import */ var core_js_modules_es6_regexp_replace__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es6.regexp.replace */ "./node_modules/core-js/modules/es6.regexp.replace.js");
...
/* harmony import */ var _idb_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./idb.js */ "./src/idb.js");
/* harmony import */ var _DataModule_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DataModule.js */ "./src/DataModule.js");
/* harmony import */ var _DOMModule_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DOMModule.js */ "./src/DOMModule.js");
...
(function () {
  var DBVersion = 7;
  var DOM = new _DOMModule_js__WEBPACK_IMPORTED_MODULE_6__["DOMModule"]();
  var DB = new _DataModule_js__WEBPACK_IMPORTED_MODULE_5__["DataModule"](DBVersion, DOM);

  function displayCards() {
    return _displayCards.apply(this, arguments);
  }

  function _displayCards() {
    _displayCards = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee4() {
      var cardsByTopic, favourites;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return DB.getTopicsWithCards();

            case 2:
              cardsByTopic = _context4.sent;
            ...
            case 6:
              ...
              _context4.next = 10;
              return onSelectChange(cardsByTopic);
  ...
  function onSelectChange(_x) {
    return _onSelectChange.apply(this, arguments);
  }

  function _onSelectChange() {
    _onSelectChange = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee5(cardsByTopic) {
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
            ...
            case 3:
              cardsByTopic = _context5.sent;

            case 4:
              DOM.updateCardSelect(cardsByTopic);
              _context5.next = 7;
              return showCardsDetail();
  ...
  function showCardsDetail(_x2) {
    return _showCardsDetail.apply(this, arguments);
  }

  function _showCardsDetail() {
    _showCardsDetail = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee6(isRefresh) {
      var slug, cardDetails;
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              slug = DOM.getSelectedCard();
              _context6.next = 3;
              return DB.getCardDetail(slug, isRefresh);

            case 3:
              cardDetails = _context6.sent;
  ...
  function refreshCardDetail() {
    return _refreshCardDetail.apply(this, arguments);
  }

  function _refreshCardDetail() {
    _refreshCardDetail = _asyncToGenerator(
    /*#__PURE__*/
  ...
  function updateFavourite(_x3) {
    return _updateFavourite.apply(this, arguments);
  }

  function _updateFavourite() {
    _updateFavourite = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee8(event) {
      var state, slug, favourites;
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              if (event.target && event.target.matches("#favBtn")) {
                ...
                state = JSON.parse(event.target.dataset.state);
                slug = event.target.dataset.slug;
                if (state) DB.removeFavourite(slug);else DB.markFavourite(slug);
  ...
  function showCardDetailFromFavouritesHelper(_x4) {
    return _showCardDetailFromFavouritesHelper.apply(this, arguments);
  }

  function _showCardDetailFromFavouritesHelper() {
    _showCardDetailFromFavouritesHelper = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee9(e) {
      var select, selectedElement;
      return regeneratorRuntime.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              select = e.target;
              selectedElement = select[select.selectedIndex];
              showCardDetailFromFavourites(selectedElement.value);
  ...
  function showCardDetailFromFavourites(_x5) {
    return _showCardDetailFromFavourites.apply(this, arguments);
  }

  function _showCardDetailFromFavourites() {
    _showCardDetailFromFavourites = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee10(slug) {
      var cardDetails;
      return regeneratorRuntime.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              _context10.next = 2;
              return DB.getCardDetail(slug);

            case 2:
              cardDetails = _context10.sent;
              DOM.updateCardDetails(slug, cardDetails);
  ...
  function searchCards(_x6) {
    return _searchCards.apply(this, arguments);
  }

  function _searchCards() {
    _searchCards = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee11(e) {
      var searchText, cards;
      return regeneratorRuntime.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.next = 3;
              return DB.cardsWithText(searchText);
  ...
  function showCardFromSearch(_x7) {
    return _showCardFromSearch.apply(this, arguments);
  }

  function _showCardFromSearch() {
    _showCardFromSearch = _asyncToGenerator(
    /*#__PURE__*/
  ...
  function showCardFromLink(_x8) {
    return _showCardFromLink.apply(this, arguments);
  }

  function _showCardFromLink() {
    _showCardFromLink = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee13(e) {
      ...
      return regeneratorRuntime.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              slug = e.target.href.replace(/(.+\/task-card\/)/g, "");
              showCardDetailFromFavourites(slug);
  ...
  (function registerServiceWorker() {
    window.isUpdateAvailable = new Promise(function (resolve, reject) {
      var refreshing; // lazy way of disabling service workers while developing

      if ("serviceWorker" in navigator) {
        // register service worker file
        navigator.serviceWorker.register("service-worker.js").then(function (reg) {
          console.log('sw installed');
          DB.checkForNewCardsAndSave(true);
  ...
  document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("taskcard_details").addEventListener("click", function (e) {
      if (e.target && e.target.matches("a")) {
        e.preventDefault();
        showCardFromLink(e);
      }
    });
    document.getElementById("cardSelect").addEventListener("input",
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
    ...
    document.getElementById("topicSelect").addEventListener("input",
    /*#__PURE__*/
    function () {
    ...
    document.getElementById("taskcard_details").addEventListener("touchstart", function (e) {
      return updateFavourite(e);
    });
    document.getElementById("taskcard_details").addEventListener("click", function (e) {
      return updateFavourite(e);
    });
    document.getElementById("searchInput").addEventListener("change", function (e) {
      return searchCards(e);
    });
    document.getElementById("filteredCards").addEventListener("input", function (e) {
      return showCardFromSearch(e);
    });
    document.getElementById("favouriteList").addEventListener("change", function (e) {
      return showCardDetailFromFavouritesHelper(e);
    });
    displayCards();

    if (!"serviceWorker" in navigator || location.protocol !== "https:") {
      console.log("No service worker");
      DB.checkForNewCardsAndSave(false);
    } else {
